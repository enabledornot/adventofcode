...
impl Plane {
    ...
    fn check_mirror_row(&self, r0: usize) -> bool {
        for e in 0..=min(r0,(self.i-2).wrapping_sub(r0)) {
            if ! self.compare_row(r0-e,r0+e+1) {
                return false;
            }
        }
        return true;
    ...
    fn check_mirror_column(&self, c0: usize) -> bool {
        for e in 0..=min(c0,(self.ii-2).wrapping_sub(c0)) {
            if ! self.compare_column(c0-e,c0+e+1) {
                return false;
            }
        }
        return true;
    ...
    fn compare_row(&self, r0: usize, r1: usize) -> bool {
    ...
    fn compare_column(&self, c0: usize, c1: usize) -> bool {
